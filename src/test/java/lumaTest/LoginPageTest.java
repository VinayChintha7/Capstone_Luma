...
//
//public class LoginPageTest extends BaseClass {
//    LoginPage loginPage; //Accessing methods from login page by creating an object for login page.
//    ExcelUtil excelReader = new ExcelUtil("C:\\Users\\Dinesh\\eclipse-workspace\\LumaTestAutomation\\src\\test\\resources\\ExcelUtil.java");
//
//    @DataProvider(name = "LoginData")
//    public Object[][] getLoginData() {
////    	System.out.println("Reading data from Excel Sheet.");
//        int rows = excelReader.getRowCount("Sheet1"); //Counting number of rows in the sheet
////        System.out.println(rows); //Printing total rows.
//        Object[][] data = new Object[rows][2];
//
//        for (int i = 1; i <= rows; i++) {  // Skip header row as we have headers of email and password
//            data[i - 1][0] = excelReader.getCellData("Sheet1", i, 0); // Email from excel sheet
//            data[i - 1][1] = excelReader.getCellData("Sheet1", i, 1); // Password 
//        }
//        return data;
//    }
//
//    @Test(priority = 2, dataProvider = "LoginData")  // Runs after Registration (priority 1)
//    public void testLogin(String email, String password) {
//    	System.out.println("Logging in using credentials from Excel Sheet.");
//        driver.get("https://magento.softwaretestingboard.com/customer/account/login/");
//        loginPage = new LoginPage(driver);
//
//        loginPage.loginUser(email, password);
...
//import com.luma.utils.ExcelReader;
//
//public class LoginTest extends BaseTest {
//    LoginPage loginPage;
//    ExcelReader excelReader = new ExcelReader("src/test/resources/LoginData.xlsx");
//
//    @DataProvider(name = "LoginData")
//    public Object[][] getLoginData() {
//        int rows = excelReader.getRowCount("Sheet1");
